...
Page::Page(const VkDevice &device, VulkanPhysicalDevice &physicalDevice, const VkQueue &graphicsQueue, int graphicsFamily, FreetypeFace &face, HarfbuzzFont &font)
	:
...
TextCache::TextCache(const VkDevice &device_, VulkanPhysicalDevice &physicalDevice_, const VkQueue &graphicsQueue_, int graphicsFamily_, FreetypeFace &face_, HarfbuzzFont &font_)

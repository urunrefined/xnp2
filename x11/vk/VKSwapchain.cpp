...
VulkanSwapchain::VulkanSwapchain(
    VkInstance &instance_, const VkPhysicalDevice &physicalDevice_,
    VkDevice &device_, VkCommandPool &commandPool_, VkQueue &graphicsQueue_,
...
VulkanSwapchain::~VulkanSwapchain() { clean(); }

void VulkanSwapchain::create(std::vector<VkImage> &swapChainImages,
...
void VulkanSwapchain::reCreate(std::vector<VkImage> &swapChainImages,
                               VkFormat swapChainImageFormat,
                               VkExtent2D swapChainExtent) {
    clean();
...
void VulkanSwapchain::createImageViews(std::vector<VkImage> &swapChainImages,
    ...
    for (auto &swapChainImage : swapChainImages) {
        swapChainImageViews.push_back(std::make_unique<VulkanImageView>(
            device, swapChainImage, swapChainImageFormat,
...
void VulkanSwapchain::createFramebuffers(VkExtent2D swapChainExtent) {
    ...
    for (auto &imageView : swapChainImageViews) {
        ...
        swapChainFramebuffers.push_back(std::make_unique<VulkanFramebuffer>(
            device, swapChainExtent, renderPass, attachments));
    }
}

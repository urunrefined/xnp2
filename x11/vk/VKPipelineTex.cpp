...
PipelineTex::PipelineTex(const VkDevice &device_, ShaderStore &shader3D,
    ...
    vertShaderStageInfo.module = shader3D.vertTex;
...
VkPipeline &PipelineTex::getPipeline() { return pipeline; }

void PipelineTex::record(VulkanRenderBuffer &renderBuffer,

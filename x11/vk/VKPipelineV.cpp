...
PipelineV::PipelineV(const VkDevice &device_, ShaderStore &shader3D,
    ...
    vertShaderStageInfo.module = shader3D.vertTri;
    ...
    fragShaderStageInfo.module = shader3D.fragTri;
...
VkPipeline &PipelineV::getPipeline() { return pipeline; }

void PipelineV::record(VulkanRenderBuffer &renderBuffer, size_t drawCount) {
    if (!drawCount)
        return;

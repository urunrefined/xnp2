...
TextDisplayList::TextDisplayList(VulkanDevice &device, VulkanPhysicalDevice &physicalDevice, VulkanSampler &sampler, VulkanDescriptorLayoutExt &layout, std::vector<MappingAssoc> &map)
...
void TextDisplayList::render(VulkanRenderer &renderer, VulkanRenderBuffer &renderBuffer){
	for(auto & res : resources){
